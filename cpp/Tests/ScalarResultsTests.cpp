...
TEST(TestEnumeration) {
    ...
    auto dummyResult =
        *std::find_if(resultsList.begin(), resultsList.end(),
    ...
    dummyResult = *std::find_if(resultsList.begin(), resultsList.end(), [](const ScalarResult &r) {
        return r.getTradeId() == DummyTradeIdTwo;
    });
    ...
    dummyResult = *std::find_if(resultsList.begin(), resultsList.end(), [](const ScalarResult &r) {
        return r.getTradeId() == DummyTradeIdFour;
    });
