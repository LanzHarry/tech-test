...
class BaseTrade : public ITrade {
  public:
    ...
    void setTradeDate(const std::chrono::system_clock::time_point &date) override {
        tradeDate_ = date;
    }
    ...
    std::string getCounterparty() const override {
    ...
    void setNotional(double notional) override {
        notional_ = notional;
    }
    ...
    std::string getTradeId() const override {
        return tradeId_;
    }
